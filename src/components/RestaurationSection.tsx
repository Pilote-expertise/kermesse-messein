...
import { restaurationManger, restaurationBoire } from "@/data/stands";
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-12">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
            {restaurationManger.map((item, index) => (
              <div
                key={index}
                className="bg-gradient-to-br from-orange-50 to-amber-50 border-2 border-orange-100 rounded-xl p-4 shadow-md hover:shadow-lg hover:scale-105 transition-all text-center group cursor-default"
              >
        ...
        <div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-4">
            {restaurationBoire.map((item, index) => (
              <div
                key={index}
                className="bg-gradient-to-br from-cyan-50 to-blue-50 border-2 border-cyan-100 rounded-xl p-4 shadow-md hover:shadow-lg hover:scale-105 transition-all text-center group cursor-default"
              >
                <span className="text-4xl block mb-2 group-hover:animate-wiggle">
                  {item.icon}
                </span>
